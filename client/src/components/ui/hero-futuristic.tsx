 ...
 * - Pure black canvas; Three.js WebGPU scene is the sole visual centerpiece
 * - Bloom + red scan line from Three.js provides all color drama
 * - White glowing Orbitron title text floats above the scene
 * - Ghost-style "Scroll to explore" button at bottom center
 * - Mouse parallax via depth map
 */
    ...
    <div className="h-svh relative bg-black overflow-hidden">
      ...
      <div className="h-svh uppercase items-center w-full absolute z-60 pointer-events-none px-10 flex justify-center flex-col">
        <div className="text-3xl md:text-5xl xl:text-6xl 2xl:text-7xl font-extrabold">
          <div className="flex space-x-2 lg:space-x-6 overflow-hidden text-white hero-title">
